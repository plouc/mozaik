...
module.exports = {
    user: function (params) {
        return buildApiRequest(config.api.github.baseUrl + '/users/' + params.user)
            .then(function (res) {
                return res.body;
            })
        ;
    ...
    pullRequests: function (params) {
        return buildApiRequest(config.api.github.baseUrl + '/repos/' + params.repository + '/pulls')
            .then(function (res) {
                return res.body;
            })
        ;
    ...
    branches: function (params) {
        return buildApiRequest(config.api.github.baseUrl + '/repos/' + params.repository + '/branches')
            .then(function (res) {
    ...
    branch: function (params) {
        return buildApiRequest(config.api.github.baseUrl + '/repos/' + params.repository + '/branches/' + params.branch)
            .then(function (res) {
                return res.body;
            })
        ;
    ...
    repositoryContributorsStats: function (params) {
        return buildApiRequest(config.api.github.baseUrl + '/repos/' + params.repository + '/stats/contributors')
            .then(function (res) {
                return res.body;
            })
        ;
